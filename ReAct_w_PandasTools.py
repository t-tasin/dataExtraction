...
llm2 = Anthropic(model="claude-3-opus-20240229",
...
You MUST ONLY insert strings or numerical types inside of a list you are passing as a parameter, not more lists
...
#"Which data stream (Electric Power, Water, Natural Gas, emissions) is the largest for British Columbia_Canada_257?",
#"How does the water consumption vary by site in India?",
#"What is the impact of estimated data on the overall energy reporting for Tocantins_Brazil_68?",
#"Which site has the largest decrease in emissions between 2021 and 2023?",
]
